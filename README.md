...
- держит верхнюю панель компактной: запись/стоп, копирование, выбор языка, меню перевода, меню "Еще" и кнопка "Настройки";
...
- Пункт "Автоформат" в меню "Еще" применяет эти правила к тексту, который уже находится в окне; повторный вызов возвращает прежний вариант.
