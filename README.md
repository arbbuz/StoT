...
Для пилота используется `ggml-small-q5_1.bin`. Модели ниже `small-q5_1` не используются в пользовательском сценарии из-за недостаточной практической точности.
