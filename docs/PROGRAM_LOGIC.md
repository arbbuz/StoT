...
2. Пользователь при необходимости открывает "Настройки" и выбирает микрофон или backend. Модель распознавания фиксирована: `ggml-small-q5_1.bin`.
...
11. `whisper-cli.exe` читает WAV и рабочую локальную модель `ggml-small-q5_1.bin` из `models`.
