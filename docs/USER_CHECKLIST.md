...
2. При первом запуске на новом ПК в этой вкладке нажать "Найти микрофон" и говорить обычной громкостью, затем нажать "Проверить".
...
4. Нажать "Найти микрофон" и говорить обычной громкостью, затем нажать "Проверить" на найденном устройстве.
5. В списке "Микрофон" показываются сгруппированные устройства записи. Dicta сначала пробует обычные Windows audio backend, а скрытые технические backend использует только последним fallback.
