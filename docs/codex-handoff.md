...
- Fresh packaged EXE for manual verification was rebuilt on 2026-05-26 20:08:50 at `C:\Users\Olga\Documents\VoiceHelper\dist\Dicta\Dicta.exe`.
...
- `scripts\build_dicta_exe.ps1` on 2026-05-26 with build output captured in `artifacts\build_dicta_exe_20260526_200828.log`
- `dist\Dicta\Dicta.exe --self-test --allow-missing-models`

Latest successful build log:

- `artifacts\build_dicta_exe_20260526_200828.log`
